...
button_exchange = InlineKeyboardButton('💰 Курс Биткоина',
                                       callback_data='exchange')
button_balance = InlineKeyboardButton('💼 Биткоин кошелек',
                                      callback_data='balance')

# создаем инлайн клавиатуру с двумя кнопками
admin_inline = InlineKeyboardMarkup(row_width=2)
admin_inline.insert(InlineKeyboardButton("Рассылка",
